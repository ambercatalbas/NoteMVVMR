...
public enum Asset {
    ...
    public enum Icons {
        ...
        public static let emailIcon = ImageAsset(name: "icons8-email-64")
        public static let passwordIcon = ImageAsset(name: "password")
        public static let addIcon = ImageAsset(name: "add-icon")
        public static let arrowIcon = ImageAsset(name: "arrow-icon")
        public static let backIcon = ImageAsset(name: "back-icon")
